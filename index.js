...
const commands = [
    ...
    new SlashCommandBuilder()
        ...
        .addStringOption(o => o.setName("rang").setDescription("Rang (rol naam)").setRequired(true))
...
client.on("interactionCreate", async (interaction) => {
    try {
        ...
        if (cmd === "contributie") {
            ...
            const vooruitBetaling = interaction.options.getString("voortuibetaling");
                ...
                embeds: [
                    new EmbedBuilder()
                        ...
                        .addFields(
                            ...
                            { name: "💸 Vooruitbetaling", value: vooruitBetaling }
                        )
                        .setThumbnail(persoon.displayAvatarURL({ dynamic: true }))
                ]
            });
